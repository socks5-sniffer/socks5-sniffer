...
My focus other than fun projects will generally revolve around access control, API Security, and Data Protection.  Other security practices executed to keep the code safe and stable include:
